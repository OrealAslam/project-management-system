...
Route::post('register', [IndexController::class, 'registerUser'])->name('user.register');
...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::post('create-task-log', [TaskLogController::class, 'createLog'])->name('create.task.log');
...
// Test Controller
// Route::get('time', [TestController::class, 'setTime']);
// Route::post('time', [TestController::class, 'getTime']);

// Route::get('check', [TestController::class, 'test']);
// Route::get('check', [TestController::class, 'call']);
